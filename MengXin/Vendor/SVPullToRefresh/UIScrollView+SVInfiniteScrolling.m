...
//easeeeeeeeee add
- (UIView *)viewForStateLoading{
    UIView *customView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SVInfiniteScrollingViewHeight)];
    //小菊花
    UIActivityIndicatorView *activityIndicator = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray];
    [activityIndicator startAnimating];
    [activityIndicator setCenter:CGPointMake(SCREEN_WIDTH/2-60, CGRectGetHeight(customView.frame)/2)];
    
    //提示文字
    UILabel *loadingLabel = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/2-30, (CGRectGetHeight(customView.frame)-25)/2, 100, 25)];
